...
Esse desafio tem o objetivo de desenvolver um aplicativo de gestão de transações, através do Node.js junto ao TypeScript, incluindo o uso de banco de dados com o TypeORM e envio de arquivos com o Multer.

É uma aplicação que armazena transações financeiras de entrada e saída e permitir o cadastro e a listagem dessas transações, além de permitir a criação de novos registros no banco de dados a partir do envio de um arquivo csv.
